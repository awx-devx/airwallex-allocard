...
**Active task:** A3.4 — add member + preview
**Last green `pnpm verify`:** 2026-08-15 (A3.3)
...
| A     | A3 People & access      | in progress  | 4 / 10  |
| A     | A4–A9 Application       | not started  | —       |

A3.3 **done**. Next: **A3.4** add member + preview. Visual direction: `docs/VISUAL-DIRECTION.md`.
