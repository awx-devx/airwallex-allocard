...
**Active task:** A9.4 — Organization rollup
**Last green `pnpm verify`:** 2026-08-17 (A9.3)
...
| A     | A9 Reports & closure       | in progress  | 4 / 10  |

A9 **in progress**. Policies locked; A9.3 project report done. Next is A9.4 organization rollup. Visual direction: `docs/VISUAL-DIRECTION.md`.
