...
**Active task:** B0.4 — Mongoose connection
**Last green `pnpm verify`:** 2026-08-07 (B0.3)
**Blocked on:** nothing
...
| ----- | ----------------------- | --------------- | ------ |
| B     | B0 Foundation           | **in progress** | 3 / 13 |
...
B0.3 env validation is in. Next is B0.4 — Mongoose connection cached on `globalThis`.
