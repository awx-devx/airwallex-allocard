...
**Active task:** F3.23 — App shell onto tokens
**Last green `pnpm verify`:** 2026-08-14 (F3.22)
...
| F     | F3 UI library           | in progress  | 23 / 26 |
| A     | A1–A9 Application       | not started  | —       |

F3 in progress. **F3.22 complete** — DataTable. Next: F3.23 App shell.
