...
**Active task:** B4.2 — Formula parser (`lib/formula`)
**Last green `pnpm verify`:** 2026-08-09 (B4.1)
**Blocked on:** nothing
...
B4.1 models complete. Next: B4.2 formula parser.
