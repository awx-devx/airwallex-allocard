...
**Active task:** B8.4 — Process webhooks → ledger
**Last green `pnpm verify`:** 2026-08-11 (B8.3)
**Blocked on:** nothing
...
| B     | B8 Money in motion      | **in progress** | 4 / 11  |
...
B8.3 webhook HMAC done. Active: **B8.4** — process webhooks → ledger.
