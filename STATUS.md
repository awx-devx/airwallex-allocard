...
**Active task:** F2.2 — `src/lib/money.ts`
**Last green `pnpm verify`:** 2026-08-12 (F2.1)
**Blocked on:** nothing
...
**F2 in progress (2026-08-12).** Next: **F2.2** — money helpers (`src/lib/money.ts`).

F2.1: `react-hook-form` 7.85.0 + `@hookform/resolvers` 5.7.1.
