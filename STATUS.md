...
**Active task:** B7.6 — Ledger commitment / release pairing
**Last green `pnpm verify`:** 2026-08-11 (B7.5)
**Blocked on:** nothing
...
| B     | B7 Requests & approvals | **in progress** | 6 / 11  |
...
Active: **B7.6** — commitment/release ledger pairing tests.
