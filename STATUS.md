...
**Active task:** B6.6 — Apply + record (steps 7–8) + synchronous Redis policy snapshot
**Last green `pnpm verify`:** 2026-08-11 (B6.5)
**Blocked on:** nothing
...
| B     | B6 Rules engine         | **in progress** | 6 / 15  |
...
Active: **B6.6** — apply + record, Redis policy snapshot written before returning.
