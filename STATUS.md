...
**Active task:** B6.7 — Simulation (pipeline stop after step 6)
**Last green `pnpm verify`:** 2026-08-11 (B6.6)
**Blocked on:** nothing
...
| B     | B6 Rules engine         | **in progress** | 7 / 15  |
...
Active: **B6.7** — simulation: same pipeline, stopped after step 6, zero writes.
