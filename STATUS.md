...
**Active task:** A8.7 — Missing-receipt queue + attach
**Last green `pnpm verify`:** 2026-08-17 (A8.6)
...
| A     | A8 Activity & transactions | **in progress** | 7 / 9   |
| A     | A9 Reports & closure       | not started     | —       |

A8 **in progress**. Policies locked; A8.6 card tx links done. Next is A8.7 receipts queue. Visual direction: `docs/VISUAL-DIRECTION.md`.
