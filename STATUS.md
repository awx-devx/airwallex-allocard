...
**Active task:** B3.9 — Access history + access reviews (await go-ahead)
**Last green `pnpm verify`:** 2026-08-09 (B3.8)
**Blocked on:** user confirmation before starting B3.9
...
| B     | B3 Access control       | **in progress** | 9 / 14  |
...
B3.8 committed. Do not start B3.9 until the user confirms.
