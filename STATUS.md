...
**Active task:** B4.6 — GET + PUT project budget
**Last green `pnpm verify`:** 2026-08-09 (B4.5)
**Blocked on:** nothing
...
B4.5 ledger write path complete. Next: B4.6 GET + PUT budget.
