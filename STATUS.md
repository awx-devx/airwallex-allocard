...
**Active task:** A3.5 — edit / remove member
**Last green `pnpm verify`:** 2026-08-15 (A3.4)
...
| A     | A3 People & access      | in progress  | 5 / 10  |
| A     | A4–A9 Application       | not started  | —       |

A3.4 **done**. Next: **A3.5** edit / remove member. Visual direction: `docs/VISUAL-DIRECTION.md`.
