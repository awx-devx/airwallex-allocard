...
**Active task:** F2.7 — Formatting & display helpers
**Last green `pnpm verify`:** 2026-08-12 (F2.6)
**Blocked on:** nothing
...
**F2 in progress (2026-08-12).** Next: **F2.7** — format helpers.

F2.6: useZodForm + applyServerErrors + unsaved guard.
