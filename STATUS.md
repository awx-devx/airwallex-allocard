...
**Active task:** B6.8 — Attributes HTTP API (registry, values, ingest)
**Last green `pnpm verify`:** 2026-08-11 (B6.7)
**Blocked on:** nothing
...
| B     | B6 Rules engine         | **in progress** | 8 / 15  |
...
Active: **B6.8** — attributes HTTP API: registry, values, signed ingest.
