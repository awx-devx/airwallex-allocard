...
**Active task:** A5.5 — Freeze, unfreeze, close, reconcile
**Last green `pnpm verify`:** 2026-08-16 (A5.4)
...
| A     | A5 Cards                | in progress  | 5 / 11  |
| A     | A6–A9 Application       | not started  | —       |

A5 **in progress**. Next: **A5.5** freeze / unfreeze / close / reconcile. Visual direction: `docs/VISUAL-DIRECTION.md`.
