...
**Active task:** F3.15 — CardVisual
**Last green `pnpm verify`:** 2026-08-14 (F3.14)
...
| F     | F3 UI library           | in progress  | 15 / 26 |
| A     | A1–A9 Application       | not started  | —       |

F3 in progress. **F3.14 complete** — PermissionGate. Next: F3.15 CardVisual.
