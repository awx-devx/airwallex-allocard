...
**Active task:** B4.3 — Projection pure function
**Last green `pnpm verify`:** 2026-08-09 (B4.2)
**Blocked on:** nothing
...
B4.2 formula parser complete. Next: B4.3 projection pure function.
