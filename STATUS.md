...
**Active task:** B5.7 — Cardholder provisioning on member-add
**Last green `pnpm verify`:** 2026-08-11 (B5.6)
**Blocked on:** nothing
...
Active: **B5.7** — Cardholder provisioning on member-add + cardholder service.
