...
**Active task:** B5.4 — Cardholder + Card repositories
**Last green `pnpm verify`:** 2026-08-11 (B5.3)
**Blocked on:** nothing
...
Active: **B5.4** — Cardholder + Card repositories.
