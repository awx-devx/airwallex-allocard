...
**Active task:** B8.5 — POST /api/remote-auth
**Last green `pnpm verify`:** 2026-08-11 (B8.4)
**Blocked on:** nothing
...
| B     | B8 Money in motion      | **in progress** | 5 / 11  |
...
B8.4 ledger mapping done. Active: **B8.5** — remote authorization.
