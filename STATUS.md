...
**Active task:** F2.8 — Rules helpers
**Last green `pnpm verify`:** 2026-08-12 (F2.7)
**Blocked on:** nothing
...
**F2 in progress (2026-08-12).** Next: **F2.8** — rules sentence/highlighter.

F2.7: status/MCC/country/merchant/card/truncate format helpers.
