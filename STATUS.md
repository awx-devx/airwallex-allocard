...
**Active task:** B9.1 — Unified activity feed
**Last green `pnpm verify`:** 2026-08-12 (B9.0)
**Blocked on:** nothing
...
| B     | B9 Reporting & closure  | **in progress** | 1 / 11  |
...
B9.0 complete (contracts + schemas). Active: **B9.1** — unified activity feed service + HTTP.
